<div class="container-scroller">
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#tables" aria-expanded="false" aria-controls="tables">
              ...
              <span class="menu-title">Tables Product</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../../pages/tables/basic-table.php">Upload Product</a></li>
              </ul>
            </div>
          </li>
    ...
    <?php include './upload/Product-Upload.php'; ?>
    ...
    <?php include './ProductTable/product-table.php'; ?>
